...
public class constant {
	...
	public final static String GECKO_DRIVER_DIRECTORY = System.getProperty("user.dir") + "driverManager\\geckodriver.exe";
	
	public final static String CHROME_DRIVER_DIRECTORY = System.getProperty("user.dir") + "driverManager\\chromedriver.exe";
	
	public final static String IE_DRIVER_DIRECTORY = System.getProperty("user.dir") + "driverManager\\IEDriverServer.exe";
