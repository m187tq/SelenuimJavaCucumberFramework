package helper.axe.actiondriver;

import helper.axe.actioninterface.ActionInterface;
...
public class Action implements ActionInterface {
	...
	public boolean switchToFrameByIndex(WebDriver driver,int index) {
		boolean flag = false;
		try {
			new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//iframe")));
